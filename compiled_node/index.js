...
function executeStartupTasks() {
    ...
    return realmHandler.performMigration().then(openRealm => {
        ...
        realm.write(() => {
            ...
            log_1.logger.debug('Deleting ' + invalidRatings.length + ' ratings with no user or video');
...
app.get('/cachemanager/hitrate', function (req, res) {
    ...
    cacheManager.hitrateOfCacheManager(exports.users, startDate, endDate).then(performanceLog => {
